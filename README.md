...
## ⚙️ Requirements 
### You can run FleetApp in two ways:
### Local mode (requires .NET 8 SDK) — build and debug directly on your machine
### Docker mode (recommended) — no .NET installation needed; runs in a self-contained container
### .NET 8 SDK (optional if using Docker)
### Docker Desktop
